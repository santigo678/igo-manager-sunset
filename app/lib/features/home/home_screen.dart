    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: AppColors.violet.withOpacity(0.03), blurRadius: 6, offset: Offset(0, -2))],
        ),
        child: SafeArea(
          child: BottomNavigationBar(
            ...
            selectedItemColor: AppColors.violetL,
            unselectedItemColor: AppColors.text3,
            selectedLabelStyle: const TextStyle(fontFamily: 'Sora', fontSize: 11, fontWeight: FontWeight.w700),
